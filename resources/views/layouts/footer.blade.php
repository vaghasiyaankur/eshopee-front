<footer class="footer footer-color" >
    <div class="page-width">
       <div class="footer-container" >
          <div class="row" >
             <div class="ishiservices col-lg-4 col-md-12 col-xs-12 footer-left">
                         ...
                         <a href="collections/speaker.html">
                            <div class="service-img-outer">
                               <div class="service-img service-hover">
                                  <img class="lazyload" data-src="{{ asset('assets/images/l1.png') }}" alt="service Image">
                                  <span class="service-img-hover">
                                  <img class="lazyload" data-src="{{ asset('assets/images/lb1.png') }}" alt="service Image">
                                  </span>
                               </div>
                            </div>
                            <div class="service-text">
                               <div class="service-title">GREAT SAVINGS</div>
                               <div class="service-desc">Lorem Ipsum Is Simply Text</div>
                            </div>
                         </a>
                      </div>
                      <div class="services">
             ...
             <div class="col-lg-8 col-md-12 col-xs-12 footer-right">
                <div class="footer-content store-info-block col-md-12 footer-block">
                ...
                <div class="bottom-link-list footer-block col-md-4">
                   <div class="footer-title clearfix hidden-lg-up ishi-collapse in ishi-collapsed rotate" data-href="#policies-info-container" aria-expanded="false", data-toggle="collapse">
                   ...
                   <div id="policies-info-container" class="account-info-inner ishi-collapse desktop-collapse">
                      ...
                      <ul class="site-footer__linklist">
                         ...
                         <li class="site-footer__linklist-item">
                            <a href="25037930580/checkouts/5e02dcad4a14ab13aa7b6bf6a5f84990.html">Secure Payment</a>
                         </li>
                         <li class="site-footer__linklist-item">
                            <a href="pages/contact.html">Contact Us</a>
                         </li>
                         <li class="site-footer__linklist-item">
                            <a href="collections/special_electronic.html">Best Sales</a>
                         </li>
                      </ul>
                   </div>
                </div>
                <div class="bottom-link-list footer-information col-md-4 footer-block">
                   ...
                   <div id="account-info-container" class="account-info-inner ishi-collapse desktop-collapse">
                      ...
                      <ul class="site-footer__linklist">
                         ...
                         <li class="site-footer__linklist-item">
                            <a href="pages/about-us.html">Legal Notice</a>
                         </li>
                         <li class="site-footer__linklist-item">
                            <a href="cart.html">Prices Drop</a>
                         </li>
                         <li class="site-footer__linklist-item">
                            <a href="collections/new_electronic.html">New products</a>
                         </li>
                      </ul>
                   </div>
                </div>
                <div id= "_desktop_contact" class="hidden-lg-down">
                   <div class="footer-content contact-info col-md-4 footer-block">
                      <div id="footer-toggle-" class="contact-info ishi-collapse desktop-collapse">
          ...
          <div class="row">
             <div class="footer-left col-lg-6 col-md-12 col-sm-12">
                <div class="footer__copyright">
                   <p>© 2022, Techayo Sectioned Shopify Theme Powered by Shopify</p>
                </div>
             </div>
          ...
          <div class="modal-content popup-bg-color lazyload popup-bg-image" data-bg="{{ asset('assets/images/n-banner.png') }}">
             ...
             <div class="product-popup-modal__content-info">
                <div class=" image-cover">
                   <div class="col-md-12 col-sm-12 popup-text popup-text-left">
 ...
 <div id="shopify-section-cookieconsent" class="shopify-section cookie-consent">
    <div id="cookieconsent" style="display:none" class="position-left">
       <div class="message">
          <p>This is a cookie consent dialog which comes free of cost with the theme! You can use it if you want or disable it.</p>
       </div>
       <div class="center">
 ...
 <quickview-dialog id="qvPopupModal" class="product-swatches product-popup-modal toggle-dropdown ">
    <div role="dialog" aria-modal="true" class="product-popup-modal__content qv-wrapper" tabindex="-1">
       ...
       <div class="product-popup-modal__content-info">
          <div id="qv-images-container" class="col-md-6">
             <div id="qv-product-cover"> <img src="../cdn.shopify.com/s/files/1/0250/3793/0580/t/3/assets/no-imageac15.png?v=124062130623401294271645791720"> </div>
...
<script src="{{ asset('assets/js/includes.min.js') }}"></script>
<script src="{{ asset('assets/js/global.js') }}"></script>
<script src="{{ asset('assets/js/cart-notification.js') }}"></script>
