                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <h1 class="h3 text-dark mb-3 headerTitle text-uppercase">
                            {{$data['data_from']}} products{{ isset($brand_name) ? '('.$brand_name.')' : ''}}
                            ...
                            <form id="search-form" action="{{ route('products') }}" method="GET">
                                ...
                                <div class="form-inline flex-nowrap pb-3 for-mobile">
                                    <label
                                        ...
                                        for="sorting">
                                        <span
                                            class="{{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}}">sort_by</span></label>
                                    <select style="background: white; appearance: auto;"
                                            class="form-control custom-select" onchange="filter(this.value)">
                                        <option value="latest">Latest</option>
                                        <option
                                            value="low-high">Low_to_High Price </option>
                                        <option
                                            value="high-low">High_to_Low Price</option>
                                        <option
                                            value="a-z">A_to_Z Order</option>
                                        <option
                                            value="z-a">Z_to_A Order</option>
                                    </select>
                                </div>
                            </form>
                        </div>
                ...
                <div class="cz-sidebar rounded-lg box-shadow-lg" id="shop-sidebar" style="margin-bottom: -10px;">
                    <div class="cz-sidebar-header box-shadow-sm">
                        <button class="close {{Session::get('direction') === "rtl" ? 'mr-auto' : 'ml-auto'}}"
                                ...
                                class="d-inline-block font-size-xs font-weight-normal align-middle">Dashboard Close sidebar</span><span
                            ...
                            <div
                                ...
                                <label class="opacity-75 text-nowrap for-shoting" for="sorting"
                                    ...
                                    <select style="background: whitesmoke; appearance: auto;width: 100%"
                                        ...
                                        <option
                                            value="{{route('products',['id'=> $data['id'],'data_from'=>'best-selling','page'=>1])}}">best_selling_product</option>
                                        <option
                                            value="{{route('products',['id'=> $data['id'],'data_from'=>'top-rated','page'=>1])}}">top_rated</option>
                                        <option
                                            value="{{route('products',['id'=> $data['id'],'data_from'=>'most-favorite','page'=>1])}}">most_favorite</option>
                                    </select>
                                </label>
                            </div>
                        </div>
                ...
                <div class="cz-sidebar rounded-lg box-shadow-lg" id="shop-sidebar" style="margin-bottom: -10px;">
                    <div class="cz-sidebar-header box-shadow-sm">
                        <button class="close {{Session::get('direction') === "rtl" ? 'mr-auto' : 'ml-auto'}}"
                            ...
                            <span
                                class="d-inline-block font-size-xs font-weight-normal align-middle">Dashboard Close sidebar</span>
                            <span
                                class="d-inline-block align-middle {{Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'}}"
                            ...
                            <div class="input-group-overlay input-group-sm mb-1">
                                ...
                                <div class="input-group-append-overlay">
                                    <span style="color: #3498db;" class="input-group-text">
                                        \App\Helpers\Frontendhelper\currency_symbol()
                                    </span>
                                </div>
                            </div>
                            <div>
                    ...
                    <div class="cz-sidebar-body">
                        ...
                        <div class="widget cz-filter mb-4 pb-4 border-bottom mt-2">
                            ...
                            <ul id="lista1" class="widget-list cz-filter-list list-unstyled pt-1"
                                ...
                                @foreach(\App\Helpers\Frontendhelper::get_brands() as $brand)
                ...
                <div class="cz-sidebar rounded-lg box-shadow-lg" id="shop-sidebar">
                    ...
                    <div class="cz-sidebar-body">
                        ...
                        <div class="widget widget-categories mb-4 pb-4 border-bottom">
                            ...
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                            @php($categories=\App\Helpers\Frontendhelper::parents())
                        ...
                        <div class="">
                            ...
                            <div class="widget widget-categories mb-4 pb-4 border-bottom">
                                <h3 class="widget-title"
                                    style="font-weight: 700;">categories</h3>
                                <div class="divider-role"
                                     style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                                <div class="accordion mt-n1" id="shop-categories">
                                    @foreach($categories as $category)
