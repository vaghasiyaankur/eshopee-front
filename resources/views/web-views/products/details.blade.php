                        ...
                        <div class="position-relative {{Session::get('direction') === "rtl" ? 'ml-n4' : 'mr-n4'}} mb-3">
                            @if (count(json_decode($product->colors)) > 0)
                                <div class="flex-start">
                                    <div class="product-description-label mt-2">color:
                                    </div>
                                    <div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <div class="review d-flex align-items-center">
                                    <div class="">
                                        <span
                                            class="d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}}">Seller Info </span>
                                        <span
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <div class="review d-flex align-items-center">
                                    <div class="">
                                        <span
                                            class="d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}}">=web_admin</span>
                                        <span
                                            class="d-inline-block font-size-sm text-body align-middle mt-1 {{Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'}}"></span>
                                    </div>
                                </div>
                        ...
                        <div class="tab-content px-lg-3">
                            ...
                            <div class="tab-pane fade" id="reviews" role="tabpanel">
                                <div class="row pt-2 pb-3">
                                    ...
                                    {{$overallRating[0]}} Overall rating
                                </span>
                                    </div>
                                ...
                                <div class="row pb-4">
                                    <div class="col-12">
                                        ...
                                        @if(count($product->reviews)==0)
                                            <div class="card">
                                                <div class="card-body">
                                                    <h6 class="text-danger text-center">product_review_not_available</h6>
                                                </div>
                                            </div>
                                        @endif
                                    </div>
            ...
            <div class="view_all ">
                <div>
                    ...
                    <a class="btn btn-outline-accent btn-sm viw-btn-a"
                       href="{{route('products',['id'=> $category[0]->id,'data_from'=>'category','page'=>1])}}">view_all
        ...
        <div class="row mt-4">
            ...
            @else
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="text-danger text-center">similar product_not_available</h6>
                        </div>
                    </div>
                </div>
            @endif
