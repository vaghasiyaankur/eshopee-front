...
<div class="row rtl">
    ...
    <div class="col-xl-12 col-md-12" style="margin-top: 11px">
        @php $main_banner=\App\Model\Banner::where('banner_type','Main Banner')->where('published',1)->orderBy('id','desc')->get() @endphp
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <p class="modal-title"
                                   id="exampleModalLongTitle">banner_photo</p>
                            ...
                            <div class="modal-body">
                                ...
                                @if ($banner->url!="")
                                    <div class="text-center mt-2">
                                        <a href="{{$banner->url}}"
                                           class="btn btn-outline-accent">Explore Now</a>
                                    </div>
                                @endif
                            </div>
                        </div>
